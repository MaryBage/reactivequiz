...
const ResetPasswordForm = (props) => {
    ...
    const sbmtHandler = data => {
       ...
       if (data.psw != data.confirmed) {
              ...
              axios.post(`/reset.php`, btoa(JSON.stringify({
                   action: 'change', 
              newPsw: data.psw, 
              ...
              <div className={s.afterResetWrapper}>
                     <div className={s.afterResetTextWrapper}>
                            <div className={c.changePassWrapper}>
                                   ...
                                   <form className={c.formWrapper} onSubmit={handleSubmit(sbmtHandler)}>
                                          ...
                                          <div className={c.submitWrapper}>
                                                 <div></div>
                                                 <input type="submit" value="save changes" className={c.changePswSubmit} />
                                          </div>
                                   </form>
                                   </div>
                            </div>
