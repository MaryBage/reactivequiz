  ...
  return (
    <>
      <div className="containerAdmin">
        <div
          className="header"
          style={{ backgroundColor: `rgba(${THEME[theme]})` }}
        >
          <div style={{ width: "80%" }}>
        ...
        <div
          ...
          style={{ backgroundColor: `rgba(${THEME[theme]},.45)` }}
        >
          <CustomButton component={Link} to="/admin/addquestions">
            {adminNav[0]}
          </CustomButton>
          <CustomButton component={Link} to="/admin/questions" linear="true">
            {adminNav[1]}({db.questions.length})
          </CustomButton>
          <CustomButton component={Link} to="/admin/quizes" linear="true">
            {adminNav[2]}({db.quizes.length})
          </CustomButton>
          <CustomButton
            component={Link}
            to="/admin/students_results"
            linear="true"
          >
            {adminNav[3]}
          </CustomButton>
        ...
        <div
          className="mainAdmin"
          style={{ backgroundColor: `rgba(${THEME[theme]},.15)` }}
        >
          <Switch>
            <Route path="/admin/addquestions" component={AddForm} />
            <Route
              path="/admin/questions/:detail"
              render={() => <Questions id={user.id} />}
            />
            <Route
