...
const Feedback = () => {
  ...
  const sbmtHandler = (e) => {
    ...
    if (allFieldsFilled) {
      ...
      axios
        .get(
          `/feedback.php?fName=${fieldsValue.fName}&fEmail=${fieldsValue.fEmail}&message=${fieldsValue.message}`
        )
        .then((res) => {
      ...
      {loader ? (
        ...
        <div className="wrapper">
          ...
          <div className="changable-wrapper fromLeft">
            ...
            <form
              onSubmit={sbmtHandler}
              className={s.feedbackInformativeDivision}
            >
              ...
              <div className={s.nameAndEmailField}>
                ...
                <InformativeField
                  style={
                    sentStatus.message.includes("email")
                      ? { borderColor: "#e60000", color: "#e60000" }
                      : {}
                  }
                  onBlur={onFieldChange}
                  type="email"
